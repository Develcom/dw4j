  ...
  begin
   ...
   if (p_flag = '1') then
      ...
      open cursor_expe for
         select e.expediente, e.id_libreria, e.id_categoria, e.valor, e.fecha_indice, a.id_indice,
...
CREATE FUNCTION f_buscar_expediente_reporte(p_idcategoria integer) RETURNS refcursor
  ...
  begin
   ...
   open cursor_expe for
   SELECT e.id_expedientes, e.expediente, e.valor, e.fecha_indice,  
  ...
  order by e.id_expedientes, i.id_indice;
