...
public class PDFViewer extends JFrame
    ...
    private static final long serialVersionUID = -5043260040505924663L;
    /**
     * The current PDFFile
     */
    PDFFile curFile;
...
//        System.out.println("Going to page " + pagenum);
     ...
     * multiple-monitor setup. If false, the user will only be prompted once.
     */
     ...
     * @param force true if the user should be prompted for a screen to use the
        ...
        if (e.isAddedPath()) {
            ...
            try {
                ...
                if (action instanceof GoToAction) {
                    ...
                    PDFObject pag = dest.getPage();
                    if (pag == null) {
                        return;
                    }

                    int pageNum = curFile.getPageNumber(pag);
                    if (pageNum >= 0) {
                        gotoPage(pageNum);
                    }
                }
